...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "👋 Доброго дня {{FIRST_NAME_TEXT}}, {{LAST_NAME_TEXT}}! Вас вітає технічна підтримка, напишіть будь ласка свій номер договору та запитання. Вам відповість перший вільний оператор")
