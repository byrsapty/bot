...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "👋 Доброго дня! Вас вітає технічна підтримка, напишіть будь ласка своє запитання і Вам відповість перший вільний оператор")
