...
WELCOME_MESSAGE = os.getenv("WELCOME_MESSAGE", "👋 Доброго дня first_name, last_name! Вас вітає технічна підтримка, напишіть будь ласка свій номер договору та запитання. Вам відповість перший вільний оператор")
